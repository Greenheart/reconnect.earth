...
<nav class="flex justify-between py-2 px-4 xs:p-4 items-center max-w-screen-lg mx-auto">
  <a href="/">
...
<main class="mx-auto max-w-screen-lg mt-8 px-4 text-lg sm:text-xl">
  <header>
    <h1 class="h1 font-bold mb-4 gradient-heading">Reconnect to what matters</h1>
